...
const Search: React.FC = (props) => {
    ...
    const process = async (parsed: any) => {
        ...
        if (parsed) {
            ...
            var response = await Api.getData(`rechercherPublication?key=${parsed}&lastInsertId=10`);
    ...
    return (
        <div className="row container-fluid">
            ...
            <div className="col-2 no__padding">
                <input type="submit" className="form-control Rechercherbtn" value={!isLoad ? "Rechercher" : "Recherche..."} onClick={() => search()} />
            </div>
        </div>
    )
}
