...
const Home: React.FC = (props) => {
    ...
    return (
        <div className="container">
            <div className="row">
                <div className="col-md-2 no-padding left__menu d-sm-none d-md-block">
                    <div className="menu__title">Catégorie</div>
                   {<div className="">
                        {categorieData.map((categorie) => (
                        <div className="categirie__item" onClick={()=>history.push("/categorie:"+ categorie['id'])}>
                            <img src={"./images/" + categorie['icon_categorie']} className="categorie__image" />  {categorie['libelle_categorie']}
                        </div>))}
                    </div>}
                </div>
                <div className="col-md-2 no-padding d-md-none">
                    <div className="menu__title" onClick={display}>
                        <span>Categorie</span>
                        <span style={{fontSize: 20}}> {show ? <BiChevronsUp /> : <BiChevronsDown /> } </span>
                ...
                <div className="col-md-2 no-padding rigth__menu order-sm-first order-md-last">
                    ...
                    <div className="container-fluid">
                        <button className="btn btn-primary w-100 mb-3"><Link to="/list">Liste boutiques</Link></button>
